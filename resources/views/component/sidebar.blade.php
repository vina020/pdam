...
<head>
    ...
    <title>Sidebar PDAM Magetan</title>
...
<body>
    ...
    @endauth
        ...
        <nav class="sidebar-menu">
            ...
            <ul class="menu-list">
                <li class="menu-item">
                    <a href="{{ route('pasang-baru') }}" class="menu-link {{ request()->routeIs(['pasang-baru', 'layanan.pasang-baru', 'pasang-baru.form', 'layanan.form-pendaftaran']) ? 'active' : '' }}">
                        <i class="fas fa-faucet"></i>
                        <span>Pasang Baru</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('layanan.pengaduan') }}" class="menu-link {{ request()->routeIs('layanan.pengaduan') ? 'active' : '' }}" >
                        <i class="fas fa-headset"></i>
                        <span>Pengaduan</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('layanan.cek-tagihan') }}" class="menu-link {{ request()->routeIs('layanan.cek-tagihan', 'layanan.cek-tagihan') ? 'active' : '' }}">
                        <i class="fas fa-file-invoice"></i>
                        <span>Cek Tagihan</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('informasi-sambungan') }}" class="menu-link {{ request()->routeIs('informasi-sambungan') ? 'active' : '' }}">
                        <i class="fas fa-network-wired"></i>
                        <span>Informasi Sambungan</span>
                    </a>
                </li>
            </ul>
            ...
            <ul class="menu-list">
                <li class="menu-item">
                    <a href="{{ route('maklumat-pelayanan') }}" class="menu-link {{ request()->routeIs('maklumat-pelayanan') ? 'active' : '' }}">
                        <i class="fas fa-money-check-alt"></i>
                        <span>Maklumat Pelayanan</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('informasi.tarif-air') }}" class="menu-link {{ request()->routeIs('informasi.tarif-air') ? 'active' : '' }}">
                        <i class="fas fa-tint"></i>
                        <span>Tarif Air</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('berita') }}" class="menu-link {{ request()->routeIs('berita') ? 'active' : '' }}">
            ...
            <ul class="menu-list">
                <li class="menu-item">
                    <a href="{{ route('visi-misi') }}" class="menu-link {{ request()->routeIs('visi-misi') ? 'active' : '' }}">
                        <i class="fas fa-compass"></i>
                        <span>Visi Misi</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{ route('sejarah') }}" class="menu-link {{ request()->routeIs('sejarah') ? 'active' : '' }}">
                ...
                <li class="menu-item has-submenu">
                    <a href="#" class="menu-link menu-toggle {{ request()->routeIs(['dewan-pengawas', 'struktur-organisasi', 'susunan-direksi']) ? 'active' : '' }}">
    <i class="fa-solid fa-scale-balanced"></i>
    <span>Tata Kelola PDAM</span>
    <i class="fas fa-chevron-down submenu-arrow"></i>
</a>
                    <ul class="submenu">
                        <li class="submenu-item">
                            <a href="{{ route('dewan-pengawas') }}" class="submenu-link {{ request()->routeIs('dewan-pengawas') ? 'active' : '' }}">
                                <i class="fas fa-user-shield"></i>
                                <span>Dewan Pengawas</span>
                            </a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('struktur-organisasi') }}" class="submenu-link {{ request()->routeIs('struktur-organisasi') ? 'active' : '' }}">
                                <i class="fas fa-diagram-project"></i>
                                <span>Struktur Organisasi</span>
                            </a>
                        </li>
                        <li class="submenu-item">
                            <a href="{{ route('susunan-direksi') }}" class="submenu-link {{ request()->routeIs('susunan-direksi') ? 'active' : '' }}">
                                <i class="fas fa-user-tie"></i>
                                <span>Susunan Direksi</span>
                            </a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="menu-list">
                <li class="menu-item">
                    <a href="{{ route('user.user-pengaturan') }}" class="menu-link {{ request()->routeIs('user.user-pengaturan') ? 'active' : '' }}">
